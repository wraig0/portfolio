...
export default function Home() {
  return (
    <div className="flex flex-col items-center justify-center pb-2 subpixel-antialiased">
      <header className="bg-background sticky top-0 w-full pl-24 pr-24 flex flex-row items-center justify-end gap-4">
      ...
      <main className="flex flex-col items-center justify-between md:pt-12 md:pr-24 md:pl-24 lg:pr-0 lg:pl-0 max-w-screen-lg">
        <div className="flex flex-col gap-8 w-fit p-4 ">
          ...
          <section className="flex flex-col gap-2">
            ...
            <p>
              ...
              development and expertise in building React UI components. Skilled
              in React, TypeScript and various JavaScript technologies.
              Possessing over 6 years of experience in delivering high-quality
              solutions for flagship cloud platforms and desktop applications.
          ...
          <section className="flex flex-col gap-2">
            ...
            <p>
              ...
              enjoy playing video games, watching movies and spending time with
              my family.
            </p>
          </section>
        </div>
